...
<title>Guestbook Entries Manager</title>
</head>
...
<div id="wrap">
	...
	<div class="headerphoto"></div>
		...
		<div id="main">
			...
			include("usernav.php");?>
			<h4>View Guestbook Entries</h4>
			<a href="gblayout.php">Edit Guestbook Layout</a>
			...
			$read = mysql_query("SELECT * FROM guestbook WHERE username='$username' ORDER BY entrydate DESC LIMIT $startvalue, $limit");
			...
			echo "<p><table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr><td align=center width=\"10%\" height=\"50%\" bgcolor=\"#cccccc\"><img src=\"images/{$r['entryicon']}.gif\"></td><td align=left width=\"90%\" bgcolor=\"#cccccc\"><b>{$r['entrytitle']}</b></td><td align=center width=\"100%\" bgcolor=\"#cccccc\"><a href=\"gbedit.php?id={$r['id']}\">Edit</a></td></tr></table><table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr><td align=left width=\"50%\" bgcolor=\"#f2f2f2\">Posted on: $date<br />Posted by: <a href=\"profiles.php?user={$r1['username']}\"><b>{$r1['displayname']} ({$r1['username']})</b></a></td></tr></table><table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr><td id=\"views\" align=left width=100% bgcolor=\"#cccccc\">$entrycontent</td></tr></table><br /></p>";}
			//Starts page links:
			echo "<p align=center>";
